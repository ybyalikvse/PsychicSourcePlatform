...
export default function PortalProgramInfo() {
    ...
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Why we're doing this, what's in it for you, and how to make great videos.
        </p>
      </div>
      ...
      <Card className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-950/50 dark:to-blue-950/50 border-purple-200 dark:border-purple-900">
        <CardContent className="pt-6 space-y-3">
          <h2 className="text-lg font-semibold">You're the face of Psychic Source</h2>
        ...
        <CardContent className="pt-2">
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="flex gap-3 p-3 rounded-lg bg-muted/50">
              ...
              <div>
                <p className="text-sm font-medium">Personal Promotion</p>
            ...
            <div className="flex gap-3 p-3 rounded-lg bg-muted/50">
              ...
              <div>
                <p className="text-sm font-medium">Massive Reach</p>
                <p className="text-xs text-muted-foreground">
            ...
            <div className="flex gap-3 p-3 rounded-lg bg-muted/50">
              ...
              <div>
                <p className="text-sm font-medium">Grow Your Client Base</p>
                <p className="text-xs text-muted-foreground">
        ...
        <CardContent className="pt-2 space-y-3">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            <div className="flex items-center gap-3 p-3 rounded-lg border">
              <div className="shrink-0 rounded-md bg-pink-50 dark:bg-pink-950 p-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Short-form vertical video on our Instagram</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg border">
              <div className="shrink-0 rounded-md bg-slate-50 dark:bg-slate-950 p-2">
                <svg className="h-4 w-4 text-slate-800 dark:text-slate-200" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.88-2.88 2.89 2.89 0 012.88-2.88c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.49 6.3 6.3 0 001.86-4.49V8.75a8.26 8.26 0 004.84 1.56V6.87a4.85 4.85 0 01-1.12-.18z"/></svg>
              </div>
              <div>
                <p className="text-sm font-medium">TikTok</p>
                <p className="text-xs text-muted-foreground">Reaching new audiences on TikTok's algorithm</p>
              </div>
            </div>
          </div>
          <p className="text-xs text-muted-foreground">
        ...
        <CardContent className="pt-0">
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="audio">
              <AccordionTrigger className="text-sm hover:no-underline">
                <div className="flex items-center gap-3">
                  <Mic className="h-3.5 w-3.5 text-teal-500 shrink-0" />
                  Audio
                </div>
              </AccordionTrigger>
              <AccordionContent className="text-sm text-muted-foreground pl-7 space-y-2">
            ...
            <AccordionItem value="tips" className="border-b-0">
              ...
              <AccordionContent className="text-sm text-muted-foreground pl-7 space-y-1">
                <ul className="space-y-1.5">
                  <li className="flex gap-2"><span className="text-muted-foreground/50">&#8226;</span> Do a 5-second test recording to check lighting and audio before the real take</li>
                  <li className="flex gap-2"><span className="text-muted-foreground/50">&#8226;</span> Prop your phone against something stable or use a tripod — shaky video is distracting</li>
                  <li className="flex gap-2"><span className="text-muted-foreground/50">&#8226;</span> It's okay to do multiple takes. Pick the one where you feel most natural</li>
                  <li className="flex gap-2"><span className="text-muted-foreground/50">&#8226;</span> Read through the brief or script 2-3 times before recording so you're comfortable with the material</li>
                  <li className="flex gap-2"><span className="text-muted-foreground/50">&#8226;</span> Don't worry about being perfect — authenticity beats perfection every time</li>
                </ul>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
      ...
      <Card className="border-purple-200 bg-purple-50 dark:border-purple-900 dark:bg-purple-950">
        <CardContent className="pt-6">
          <div className="flex items-center justify-between gap-4">
            <div>
              <p className="font-medium text-purple-700 dark:text-purple-300">Ready to start creating?</p>
