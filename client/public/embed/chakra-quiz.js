/* Which Chakra Is Dominant? quiz embed.
 * Usage on any site:
 *   <div id="ps-chakra-quiz"></div>
 *   <script async src="https://psychic-source-platform.vercel.app/embed/chakra-quiz.js"></script>
...
(function () {
  ...
  var RESULT_LABEL = "Your Dominant Chakra";
  var QUESTIONS = [{"q":"What are you most focused on lately?","o":[{"t":"Stability and security","k":"root"},{"t":"Pleasure and creativity","k":"sacral"},{"t":"Confidence and goals","k":"solar"},{"t":"Love and relationships","k":"heart"}]},{"q":"Where do you feel tension when stressed?","o":[{"t":"Base of the spine or legs","k":"root"},{"t":"Lower belly","k":"sacral"},{"t":"Stomach or gut","k":"solar"},{"t":"Chest","k":"heart"}]},{"q":"What are you working to improve?","o":[{"t":"Speaking my truth","k":"throat"},{"t":"Trusting my intuition","k":"thirdeye"},{"t":"Feeling spiritually connected","k":"crown"},{"t":"Opening my heart","k":"heart"}]},{"q":"Which compliment means the most?","o":[{"t":"You're so grounded","k":"root"},{"t":"You're so expressive","k":"throat"},{"t":"You're so wise","k":"thirdeye"},{"t":"You're so creative","k":"sacral"}]},{"q":"Your ideal day includes...","o":[{"t":"A clear plan accomplished","k":"solar"},{"t":"Deep meditation","k":"crown"},{"t":"Heartfelt time with loved ones","k":"heart"},{"t":"An honest, meaningful talk","k":"throat"}]},{"q":"What do you most want more of?","o":[{"t":"Safety and roots","k":"root"},{"t":"Passion and flow","k":"sacral"},{"t":"Purpose and drive","k":"solar"},{"t":"Insight and clarity","k":"thirdeye"}]}];
  var RESULTS = {"root":{"name":"Root Chakra","color":"#c0392b","light":"#e8776a","text":"Your Root Chakra (Muladhara) leads the way. You are focused on safety, stability, and belonging, the foundations everything else is built on. When it is balanced you feel grounded and secure; nurture it with routine, rest, and time in nature."},"sacral":{"name":"Sacral Chakra","color":"#d2622a","light":"#f0a25e","text":"Your Sacral Chakra (Svadhisthana) is most active. This is the seat of creativity, pleasure, and emotional flow. You are passionate and expressive; honor this energy by making space for play, art, and joy."},"solar":{"name":"Solar Plexus Chakra","color":"#d9a800","light":"#f5d557","text":"Your Solar Plexus Chakra (Manipura) shines brightest. This is your center of confidence, willpower, and personal power. You are driven and capable; keep it balanced by pairing ambition with self-compassion."},"heart":{"name":"Heart Chakra","color":"#2e8b57","light":"#6fc593","text":"Your Heart Chakra (Anahata) leads. This is the bridge between body and spirit, the center of love, compassion, and connection. You give and feel deeply; protect this openness while keeping healthy boundaries."},"throat":{"name":"Throat Chakra","color":"#2f6fb0","light":"#74a9dd","text":"Your Throat Chakra (Vishuddha) is dominant. This governs communication, truth, and self-expression. You are here to speak your voice; the more honestly you express yourself, the more balanced you feel."},"thirdeye":{"name":"Third Eye Chakra","color":"#3f3a8c","light":"#7f79c8","text":"Your Third Eye Chakra (Ajna) leads the way. This is the center of intuition, insight, and inner vision. You perceive beyond the obvious; trust the quiet knowing that guides you and it will rarely steer you wrong."},"crown":{"name":"Crown Chakra","color":"#6a3d9a","light":"#a97fd6","text":"Your Crown Chakra (Sahasrara) is most active. This is your connection to the divine and to higher consciousness. You are spiritually attuned and seek meaning beyond the material; meditation and stillness keep you centered."}};
  ...
  function init(host) {
    if (host.__psQuiz_chakra) return; host.__psQuiz_chakra = true;
  ...
  function boot() { var host = document.getElementById("ps-chakra-quiz") || document.querySelector("[data-ps-widget='chakra-quiz']"); if (host) init(host); }
